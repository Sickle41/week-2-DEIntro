...
5. **Final checkpoint** — whole suite green (RustFS up + seeded), then the real
...
`uv run pytest` is green with RustFS running and seeded, `uv run de-pipeline`
runs end to end over the full data, and `DECISIONS.md` is filled in. The Day-1
